...
var shuffleDeck = function(deck) {
  // Your code here
  // Persist a deck of ordereddeck.
  // Persist a deck of shuffleddeck
  // Create a random index not to exceed the max of 51 (deck.length - 1)
  // While ordereddeck is > 0
  // keep pushing cards
  ...
  while (deck.length > 0) {
    ...
    deck = deck.filter(elem => elem !== deck[randomIndex]);
  }
  return shuffledDeck;
};
