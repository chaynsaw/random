 ...
 */
// I array of tasks
// O result of callback on results array
// C none?
// E none? 
...
var asyncMap = function(tasks, callback) {
  ...
  // call the callback on the results
  results = [];
  function functionPusher(func, callback) {
    (func(callback));
  }
  for (let i = 0; i < tasks.length; i++) {
    functionPusher(tasks[i].call(), (result) => results.push(result));
  }
};
